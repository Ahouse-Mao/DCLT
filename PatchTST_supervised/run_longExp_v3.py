...
parser.add_argument('--model', type=str, default='PatchTST_pretrained_v3',
                    help='model name, options: [Autoformer, Informer, Transformer, PatchTST, PatchTST_pretrained_v3]')

    ...
    def _compute_dataset_loss(self, data, soft_labels=None):
        ...
        with torch.no_grad():
            for x, idx in loader:
                ...
                out1_all = self.net(take_per_row(x, crop_offset + crop_eleft, crop_right - crop_eleft))
                out2_all = self.net(take_per_row(x, crop_offset + crop_left, crop_eright - crop_left))

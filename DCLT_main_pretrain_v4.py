...
if __name__ == '__main__':
    ...
    parser.add_argument('--max-train-length', type=int, default=600, help='For sequence with a length greater than <max_train_length>, it would be cropped into some sequences, each of which has a length less than <max_train_length> (defaults to 3000)')
